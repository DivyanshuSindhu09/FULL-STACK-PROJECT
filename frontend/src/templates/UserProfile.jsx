...
const UserProfile = ({user, posts, setShowEdit, profileId}) => {
  ...
  return (
    <div className='relative py-4 px-6 md:px-8 font-[absans] bg-white'>
    ...
    <div className='w-32 h-32 border-4 border-white shadow-lg absolute -top-16 rounded-full'>
      <img 
        ...
        alt="" 
        className='absolute rounded-full z-21' 
      />
    </div>
    ...
    <div className='w-full pt-16 md:pt-10 md:pl-36'>
        ...
        <p className='text-gray-700 text-sm max-x-md mt-4'> {user.bio} </p>
        ...
        <div className='flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-gray-500 mt-4'>
            ...
            <span className='flex font-bold items-center gap-1.5'>
                <i class="text-xl ri-calendar-2-line"></i>
