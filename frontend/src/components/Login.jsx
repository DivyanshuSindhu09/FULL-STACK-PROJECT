...
const Login = () => {
  return (
    <div className='h-screen inset-0 w-full bg-slate-900 fixed flex items-center justify-center overflow-hidden'>
        ...
        <div className="absolute w-96 h-96 blur-3xl opacity-30 top-1/3 right-10 animate-pulse transition-all rounded-full  bg-gradient-to-br from-cyan-500 via-blue-600 to-indigo-800 shadow-lg"></div>
